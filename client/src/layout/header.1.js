  ...
  render() {
    ...
    return (
      <div id="nav-header-layout" className="">
        ...
        {/* NAV BAR */}
        <nav id="nav-header-1" className="navbar navbar-toggleable-sm container">
        ...
        <button className="navbar-toggler navbar-toggler-right" type="button" data-toggle="collapse" data-target="#collapse-nav" aria-controls="collapse-nav" aria-expanded="false" aria-label="Toggle navigation">
